...
extension Array where Element == EKRecurrenceDayOfWeek {
  ...
  fileprivate var displayString: String {
    if #available(macOS 12.0, *) {
      return sorted { $0.dayOfTheWeek.rawValue < $1.dayOfTheWeek.rawValue }.compactMap { $0.displayString }.formatted()
    } else {
      return sorted { $0.dayOfTheWeek.rawValue < $1.dayOfTheWeek.rawValue }.compactMap { $0.displayString }.joined(separator: ", ")
    }
  }
}
